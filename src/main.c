...
static t_command *get_function(char *str)
{
	...
	static t_command cmd[][6] = {
		...
		[SHA256TEST] = {{SHA256TEST, "sha256", sha256, run_parameters_and_exec, display_hash}},
		[BASE64] = {{BASE64, "base64", base64, get_params_base64, display_base64}},
		[DES] = {{DES, "des", des_ecb, run_des_parameters_and_exec, display_des}},
		[DES_ECB] = {{DES_ECB, "des-ecb", des_ecb, run_des_parameters_and_exec, display_des}},
		[DES_CBC] = {{DES_CBC, "des-cbc", des_cbc, run_des_parameters_and_exec, display_des}},
